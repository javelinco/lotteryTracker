...
describe('Integration - PowerballTicket CRUD Operations', function () {
    var powerballTicketRepository = new powerball_ticket_1.PowerballTicketRepository();
    var powerballTicket = test_powerball_ticket_1.createTicket(uuid_1.v4(), uuid_1.v4());
    ...
    it('Should Save, Load and Delete', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, powerballTicketRepository.save(powerballTicket)];
                case 1:
                    saved = _a.sent();
                    return [4 /*yield*/, powerballTicketRepository.load(powerballTicket.ticketId)];
                case 2:
                    loaded = _a.sent();
                    return [4 /*yield*/, powerballTicketRepository.delete(powerballTicket.ticketId)];
                case 3:
                    deleted = _a.sent();
